...
class GithubReporterTest(unittest.TestCase):
    ...
    def test_comment_on_pr(self,
        ...
        # 4 problems on the PR, 2 new, no sending problem
        self.assertEqual(result, ('GithubReporter', 4, 2, None, 0))
    ...
    def test_comment_overflow(self,
        ...
        problems_count = reporter.max_error_reports + 2
        ...
        self.assertEqual(result,(
            'GithubReporter',
            problems_count,
            reporter.max_error_reports + 1,  # max + "Too many lint errors"
            reporter.max_error_reports,
            0,
        ))
